...
public class StateMachine {
    ...
    private static class SmHandler implements MessageHandler {
        ...
        private SmHandler(HandlerFactory hf, StateMachine sm, Function1<Integer, String> converter) {
            mSm = sm;
     ...
     */
    public StateMachine(String name, HandlerFactory handlerFactory, Function1<Integer, String> converter) {
        mName = name;
        mSmHandler = new SmHandler(handlerFactory, this, converter);
    }
