...
import org.xiaoxingqi.alarmService.interfaces.AlarmEditor;
import org.xiaoxingqi.alarmService.interfaces.Intents;
import org.xiaoxingqi.alarmService.statemachine.ComplexTransition;
import org.xiaoxingqi.alarmService.statemachine.HandlerFactory;
import org.xiaoxingqi.alarmService.statemachine.IOnStateChangedListener;
import org.xiaoxingqi.alarmService.statemachine.IState;
import org.xiaoxingqi.alarmService.statemachine.Message;
import org.xiaoxingqi.alarmService.statemachine.State;
import org.xiaoxingqi.alarmService.statemachine.StateMachine;
...
public final class AlarmCore implements Alarm, Consumer<AlarmValue> {
    ...
    public AlarmCore(AlarmActiveRecord container, IAlarmsScheduler alarmsScheduler, IStateNotifier broadcaster, HandlerFactory handlerFactory, Prefs prefs, Store store, Calendars calendars) {
        this.calendars = calendars;
        this.mAlarmsScheduler = alarmsScheduler;
        this.container = container;
        this.broadcaster = broadcaster;
        this.df = new SimpleDateFormat("dd-MM-yy HH:mm:ss", Locale.SIMPLIFIED_CHINESE);
    ...
    private class AlarmStateMachine extends StateMachine {
        ...
        public AlarmStateMachine(String initialState, String name, HandlerFactory handlerFactory) {
            super(name, handlerFactory, whatToString);
