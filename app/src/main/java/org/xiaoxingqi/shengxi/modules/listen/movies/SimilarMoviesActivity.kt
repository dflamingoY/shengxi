...
class SimilarMoviesActivity : BaseAct() {
    ...
    override fun initData() {
        adapter = object : QuickAdapter<BaseUserBean>(this, R.layout.item_similar_movies, mData) {
            override fun convert(helper: BaseAdapterHelper?, item: BaseUserBean?) {
                ...
                helper.getTextView(R.id.tv_Common_num).text = Html.fromHtml(String.format(resources.getString(R.string.string_movies_similar_1), item.common_num))
    ...
    override fun request(flag: Int) {
        OkClientHelper.get(this, "hobby/common/1", SearchUserData::class.java, object : OkResponse {
