...
class HomeUserMoviesActivity : BaseAct() {
    private val fragments = arrayListOf(MoodMoviesFragment(), WishMoviesFragment(), WishMoviesFragment())
    ...
    override fun initData() {
        ...
        if (loginBean.user_id != userId) {
            tvTitle.text = resources.getString(R.string.string_title_6)
        }
        fragments.forEach {
        ...
        titles = arrayOf("心情", resources.getString(R.string.string_movies_wish), resources.getString(R.string.string_movies_look))
