...
class HotMusicListActivity : BaseAct() {
    ...
    override fun initView() {
        tv_Title.text = "最近30天大家在唱哪些歌"
    }

    override fun initData() {
        adapter = object : QuickAdapter<BaseSearchBean>(this, R.layout.item_hot_music, mData) {
            override fun convert(helper: BaseAdapterHelper?, item: BaseSearchBean?) {
                Glide.with(this@HotMusicListActivity)
    ...
    override fun request(flag: Int) {
        OkClientHelper.get(this, "resources/3?sortType=2&pageNo=$current&recentDay=30", SearchResData::class.java, object : OkResponse {
