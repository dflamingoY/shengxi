...
class MusicPrivacyActivity : BaseThemeNoSwipeActivity() {
    private val REQUEST_SCAN_CODE = 0x00
    private var filmData: PatchData.FilmReview? = null
    private var list = 0
    ...
    override fun initView() {
        tvTitle.text = resources.getString(R.string.string_music_title) + resources.getString(R.string.string_privacySettingAct_1)
        moreAbout.setTitle(resources.getString(R.string.string_music_privacy_1))
        toggleHomePage.setText(resources.getString(R.string.string_music_privacy_2))
        toggleMemory.setText(resources.getString(R.string.string_music_privacy_3))
        toggleMachine.setText(resources.getString(R.string.string_music_privacy_4))
        toggleMoviePark.setText(resources.getString(R.string.string_music_privacy_5))
        tv_PrivacyDesc.text = resources.getString(R.string.string_music_privacy_6)
        toggleMovie_details.setText(resources.getString(R.string.string_music_privacy_8))
        toggleMovie_smiler.setText(resources.getString(R.string.string_music_privacy_9))
        toggleMovie_attention.setText(resources.getString(R.string.string_music_privacy_10))
        tv_attention.text = resources.getString(R.string.string_music_privacy_11)
    }
    ...
    override fun initEvent() {
        ...
        moreAbout.setOnClickListener {
            startActivityForResult(Intent(this, MovieScanPrivacyActivity::class.java)
                    .putExtra("type", 2)
                    .putExtra("title", resources.getString(R.string.string_music_privacy_7))
    ...
    override fun request(flag: Int) {
        when (flag) {
            0 -> {
                ...
                OkClientHelper.get(this, "users/${loginData.user_id}/visibility/3", FirmData::class.java, object : OkResponse {
    ...
    private fun updateSet() {
        ...
        val build = FormBody.Builder()
                ...
                .build()
        OkClientHelper.post(this, "users/${loginBean.user_id}/visibility/3", build, BaseRepData::class.java, object : OkResponse {
            override fun success(result: Any?) {
