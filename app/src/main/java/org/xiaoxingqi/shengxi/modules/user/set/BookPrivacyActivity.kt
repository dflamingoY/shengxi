...
class BookPrivacyActivity : BaseThemeNoSwipeActivity() {
    private val REQUEST_SCAN_CODE = 0x00
    private var filmview: PatchData.FilmReview? = null
    private var list = 0
    ...
    override fun initView() {
        tvTitle.text = resources.getString(R.string.string_book_8) + resources.getString(R.string.string_privacySettingAct_1)
        moreAbout.setTitle(resources.getString(R.string.string_book_privacy_1))
        toggleHomePage.setText(resources.getString(R.string.string_book_privacy_2))
        toggleMemory.setText(resources.getString(R.string.string_book_privacy_3))
        toggleMachine.setText(resources.getString(R.string.string_book_privacy_4))
        toggleMoviePark.setText(resources.getString(R.string.string_book_privacy_5))
        tv_PrivacyDesc.text = resources.getString(R.string.string_book_privacy_6)
        toggleMovie_details.setText(resources.getString(R.string.string_book_privacy_8))
        toggleMovie_smiler.setText(resources.getString(R.string.string_book_privacy_9))
        toggleMovie_attention.setText(resources.getString(R.string.string_book_privacy_10))
        tv_attention.text = resources.getString(R.string.string_book_privacy_11)
    }
    ...
    override fun initEvent() {
        ...
        moreAbout.setOnClickListener {
            startActivityForResult(Intent(this, MovieScanPrivacyActivity::class.java)
                    .putExtra("title", resources.getString(R.string.string_book_privacy_7))
                    .putExtra("type", 1)
    ...
    override fun request(flag: Int) {
        when (flag) {
            0 -> {
                ...
                OkClientHelper.get(this, "users/${loginData.user_id}/visibility/2", FirmData::class.java, object : OkResponse {
                    override fun success(result: Any?) {
                        result as FirmData
                        if (result.code == 0) {
                            if (result.data != null) {
                                list = result.data.review
                                filmview = result.data
    ...
    private fun updateSet() {
        ...
        val build = FormBody.Builder()
                ...
                .build()
        OkClientHelper.post(this, "users/${loginBean.user_id}/visibility/2", build, BaseRepData::class.java, object : OkResponse {
            override fun success(result: Any?) {
