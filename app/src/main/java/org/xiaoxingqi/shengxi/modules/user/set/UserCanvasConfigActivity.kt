...
class UserCanvasConfigActivity : BaseThemeNoSwipeActivity() {
    ...
    override fun initView() {
        ...
        tvTitle.text = String.format(resources.getString(R.string.string_privacyAct_27), "画")
        tv_Content.text = resources.getString(R.string.string_41)
        tv_hint_2.text = resources.getString(R.string.string_42)
    }
    ...
    override fun finish() {
        ...
        if (preValue == current)
            ...
            saveSetting(loginBean.user_id, "artwork_visibility", current) {
