...
import kotlinx.android.synthetic.main.activity_similar_music.*
...
class SimilarMusicActivity : BaseAct() {
    ...
    override fun initData() {
        adapter = object : QuickAdapter<BaseUserBean>(this, R.layout.item_similar_movies, mData) {
            override fun convert(helper: BaseAdapterHelper?, item: BaseUserBean?) {
                ...
                helper.getTextView(R.id.tv_Common_num).text = Html.fromHtml(String.format(resources.getString(R.string.string_music_8), item.common_num))
    ...
    override fun request(flag: Int) {
        OkClientHelper.get(this, "hobby/common/3", SearchUserData::class.java, object : OkResponse {
