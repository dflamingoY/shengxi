 ...
 * SwitchButton.
 */
public class SwitchButton extends View implements Checkable, SkinCompatSupportable {
    ...
    private int sb_button_colorId;//按钮的颜色
    private int checkedColorId;//打开的背景色
    private int uncheckColorId;//关闭的背景色
    private int sb_backgroundId;
    private int sb_shadow_colorId;
    private int sb_button_strokeId;//按钮边框颜色的资源id
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkButtonStrokeColor = optColor(typedArray,
                ...
                0xffDDDDDD);
        sb_button_colorId = typedArray.getResourceId(R.styleable.SwitchButton_sb_button_color, 0);
        checkedColorId = typedArray.getResourceId(R.styleable.SwitchButton_sb_checked_color, 0);
        uncheckColorId = typedArray.getResourceId(R.styleable.SwitchButton_sb_uncheck_color, 0);
        sb_backgroundId = typedArray.getResourceId(R.styleable.SwitchButton_sb_background, 0);
        sb_shadow_colorId = typedArray.getResourceId(R.styleable.SwitchButton_sb_shadow_color, 0);
        sb_button_strokeId = typedArray.getResourceId(R.styleable.SwitchButton_sb_button_stroke_color, 0);
        if (typedArray != null) {
            typedArray.recycle();
        }
...
*/
    ...
    public void applySkin() {
        try {
            ColorStateList colorButton = SkinCompatResources.getInstance().getColorStateList(sb_button_colorId);
            ColorStateList colorCheck = SkinCompatResources.getInstance().getColorStateList(checkedColorId);
            ColorStateList colorUncheck = SkinCompatResources.getInstance().getColorStateList(uncheckColorId);
            ColorStateList sb_background_ = SkinCompatResources.getInstance().getColorStateList(sb_backgroundId);
            ColorStateList shadowColors = SkinCompatResources.getInstance().getColorStateList(sb_backgroundId);
            ColorStateList buttonStrokeColors = SkinCompatResources.getInstance().getColorStateList(sb_button_strokeId);
            checkButtonStrokeColor = buttonStrokeColors.getDefaultColor();
            shadowColor = shadowColors.getDefaultColor();
            buttonPaint.setColor(colorButton.getDefaultColor());
            if (shadowEffect)
                buttonPaint.setShadowLayer(
                        shadowRadius,
                        0, shadowOffset,
                        shadowColor);
            background = sb_background_.getDefaultColor();
            checkedColor = colorCheck.getDefaultColor();
            uncheckColor = colorUncheck.getDefaultColor();
            invalidate();
        } catch (Exception e) {
        }
