    ...
    protected class EditorWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            try {
                ...
                if (decode.contains("https://www.byebyetext.com/topic")) {
                    /**
                     * 需要跳转
                     */
                    String topicName = decode.substring(decode.lastIndexOf("/") + 1);
                    getContext().startActivity(new Intent(getContext(), TopicResultActivity.class).putExtra("tag", topicName));
                    return true;
                }
        ...
        public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            try {
                ...
                if (decodeUrl.contains("https://www.byebyetext.com/topic")) {
                    /**
                     * 需要跳转
                     */
                    String topicName = decodeUrl.substring(decodeUrl.lastIndexOf("/") + 1);
                    getContext().startActivity(new Intent(getContext(), TopicResultActivity.class).putExtra("tag", topicName));
                    return true;
                } else if (decodeUrl.contains("https://www.byebyetext.com/html_id/")) {
                    String id = decodeUrl.substring(decodeUrl.lastIndexOf("/") + 1);
                    getContext().startActivity(new Intent(getContext(), ActionActivity.class)
                            .putExtra("url", id)
