package org.xiaoxingqi.shengxi.wedgit.itemdicaration;
...
/**
 * Created by DoctorKevin on 2017/7/11.
 */

public class RecycelrDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public RecycelrDivider(Context context, int orientation) {
     ...
     */
    public RecycelrDivider(Context context, int orientation, int drawableId) {
        this.setOrientation(orientation);
