 ...
 */
public class NumberPickerView extends View implements SkinCompatSupportable {
    ...
    private int textColorSelectedId = 0;
    private int textColorNormalId = 0;
    ...
    public void applySkin() {
        try {
            ColorStateList colorSelected = SkinCompatResources.getInstance().getColorStateList(textColorSelectedId);
            ColorStateList colorNormal = SkinCompatResources.getInstance().getColorStateList(textColorNormalId);
            mTextColorSelected = colorSelected.getDefaultColor();
            mTextColorNormal = colorNormal.getDefaultColor();
            postInvalidate();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.NumberPickerView_npv_TextColorSelected)) {
            textColorSelectedId = a.getResourceId(R.styleable.NumberPickerView_npv_TextColorSelected, 0);
        }
        if (a.hasValue(R.styleable.NumberPickerView_npv_TextColorNormal)) {
            textColorNormalId = a.getResourceId(R.styleable.NumberPickerView_npv_TextColorNormal, 0);
        }
        a.recycle();
    }
