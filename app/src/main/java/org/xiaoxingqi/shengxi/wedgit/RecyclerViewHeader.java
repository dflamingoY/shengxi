...
public class RecyclerViewHeader extends RelativeLayout {
    private String log = "RecyclerViewHeader";
            ...
            RecyclerViewHeader.this.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (height > 0) {
                        ...
                        mRecycler.removeItemDecoration(mRecycler.getItemDecorationAt(0));
                        mRecycler.addItemDecoration(new HeaderItemDecoration(mRecycler.getLayoutManager(), height), 0);
                    }
                }
            });
        } catch (Exception e) {
