package org.xiaoxingqi.shengxi.wedgit.discretescrollview;
...
import org.xiaoxingqi.shengxi.wedgit.discretescrollview.transform.DiscreteScrollItemTransformer;
import org.xiaoxingqi.shengxi.wedgit.discretescrollview.util.ScrollListenerAdapter;
import org.xiaoxingqi.shengxi.wedgit.skinView.SkinRecyclerView;
...
public class DiscreteScrollView extends SkinRecyclerView {
    ...
    public void setLayoutManager(LayoutManager layout) {
        if (layout instanceof DiscreteScrollLayoutManager) {
            ...
            throw new IllegalArgumentException("必须设置DiscreteScrollView 的Layoutmanager");
        }
    }
