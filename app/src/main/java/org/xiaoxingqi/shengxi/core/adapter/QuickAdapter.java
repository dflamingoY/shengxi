...
import org.xiaoxingqi.shengxi.impl.ObseverUpdate;
...
public abstract class QuickAdapter<T> extends BaseQuickAdapter<T, BaseAdapterHelper> implements ObseverUpdate {
    ...
    public void notifyHelperStatus(T bean) {

    }

    public void notifyHeart(T bean) {

    }

    public void animStatus(boolean isStart) {
