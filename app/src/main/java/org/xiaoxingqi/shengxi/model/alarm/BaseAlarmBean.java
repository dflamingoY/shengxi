...
public class BaseAlarmBean extends BaseAnimBean implements Parcelable {
    ...
    private BaseLineBean line;//台词相关信息
    ...
    private int picked_at;//是否已经设置过pick 1 true else false
    ...
    protected BaseAlarmBean(Parcel in) {
        super(in);
        ...
        line = in.readParcelable(BaseLineBean.class.getClassLoader());
    }
    ...
    public static final Creator<BaseAlarmBean> CREATOR = new Creator<BaseAlarmBean>() {
        @Override
        public BaseAlarmBean createFromParcel(Parcel in) {
            return new BaseAlarmBean(in);
        }

        @Override
        public BaseAlarmBean[] newArray(int size) {
            return new BaseAlarmBean[size];
        }
    };
    ...
    public BaseLineBean getLine() {
        return line;
    }

    public void setLine(BaseLineBean line) {
        this.line = line;
    }
    ...
    public int getPicked_at() {
        return picked_at;
    }

    public void setPicked_at(int picked_at) {
