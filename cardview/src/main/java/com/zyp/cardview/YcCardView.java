...
public class YcCardView extends FrameLayout {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        radius = a.getDimension(R.styleable.YcCardView_ycCardCornerRadius, 0);
        elevation = a.getDimension(R.styleable.YcCardView_ycCardElevation, 0);
        maxElevation = a.getDimension(R.styleable.YcCardView_ycCardMaxElevation, 0);
    ...
    public void setShadowColor(int color) {
        IMPL.initialize(mCardViewDelegate, getContext(), backgroundColor, radius,
                elevation, maxElevation, color, endShadowColor);
    }
